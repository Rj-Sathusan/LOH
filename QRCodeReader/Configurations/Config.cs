namespace LOH.Configurations
{
    class Config
    {


        public static string ApplicationName = "Health_Care";
        ...
        public static string ConnectionString = @"server=127.0.0.1;user id=root;database=loh";
    }
}
